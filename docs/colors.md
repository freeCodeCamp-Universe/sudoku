...
| --- | --- | --- | --- | --- |
| `--bg-primary` | #0a0a23 | #f5f5f0 | #0a0a23 | #f5f5f0 |
| `--bg-secondary` | #1b1b32 | #ebebe6 | #0f0f2c | #ebebe6 |
...
| `--accent-yellow` | #f1be32 | #7b5e2c | #ffeaa8 | #332200 |
| `--accent-blue` | #99c9ff | #1565c0 | #d8ecff | #0a2540 |
| `--board-clue-text` | #99c9ff | #0d47a1 | #99c9ff | #0d47a1 |
| `--color-1` | #e03535 | #e03535 | #ff4d4d | #720000 |
| `--color-2` | #f07820 | #f07820 | #fe8b1a | #a45300 |
| `--color-3` | #d4a828 | #d4a828 | #ffee00 | #918700 |
| `--color-4` | #33a850 | #33a850 | #65e165 | #008a00 |
| `--color-5` | #1aabaa | #1aabaa | #11acac | #006767 |
| `--color-6` | #3a80e0 | #3a80e0 | #4080e8 | #001cd1 |
| `--color-7` | #8e52e8 | #8e52e8 | #9447ff | #380070 |
| `--color-8` | #d3d3ff | #d3d3ff | #b0b0ff | #5f23c8 |
| `--color-9` | #808098 | #808098 | #d9d9d9 | #939393 |
| `--accent-green` | #acd157 | #00471b | #ddf2a3 | #092809 |
| `--accent-red` | #ffadad | #850000 | #fff1f1 | #4d0000 |
| `--focus-ring` | #198eee | #198eee | #198eee | #198eee |
| `--cell-border` | #4a4a5e | #d8d8e8 | #b5b5c9 | #3c3c50 |
| `--cell-bg-light` | #ffffff | #ffffff | #ffffff | #ffffff |
| `--cell-text-light` | #2c5f8a | #2c5f8a | #2c5f8a | #0a2540 |
| `--box-boundary` | #4a4a5e | #b8b8cc | #ffffff | #0a0a23 |
| `--board-frame` | #9898b8 | #8080a8 | #ffffff | #0a0a23 |
| `--cell-diagonal-bg` | #3b3b4f | #e8e8fa | #5f5f81 | #8f8fa8 |
| `--cell-window-bg` | #3b3b4f | #e8e8fa | #5f5f81 | #8f8fa8 |
| `--cell-special-bg` | #3b3b4f | #e8e8fa | #5f5f81 | #8f8fa8 |
| `--cell-even-bg` | #3b3b4f | #e8e8fa | #60607a | #8f8fa8 |
| `--cell-odd-bg` | #12123a | #ffffff | #0f0f2c | #ffffff |
| `--cell-peer-even-bg` | #2c2c4c | #d8d8f0 | #5e5e78 | #8989a2 |
| `--cell-peer-odd-bg` | #1a1a40 | #ededf6 | #0b0b24 | #fafafc |
| `--cell-overlap-2-bg` | #222248 | #eeeef8 | #222248 | #eeeef8 |
| `--cell-overlap-3-bg` | #272751 | #e9e9f6 | #272751 | #e9e9f6 |
| `--cell-overlap-4-bg` | #2c2c5a | #e4e4f4 | #2c2c5a | #e4e4f4 |
| `--cell-overlap-5-bg` | #313163 | #dfdff2 | #313163 | #dfdff2 |
| `--board-overlap-2-bg` | #222248 | #ececf8 | #45455f | #c8c8d6 |
| `--board-overlap-3-bg` | #272751 | #e8e8f5 | #525272 | #b4b4c4 |
| `--board-overlap-4-bg` | #2c2c5a | #e4e4f2 | #5c5c81 | #a0a0b2 |
| `--board-overlap-5-bg` | #313163 | #e0e0ee | #63638a | #8f8f9e |
...
| `--candidate-text` | #aaaacc | #555570 | #f0f0fa | #14142e |
| `--overlay-argyle-stroke` | #9898b8 | #8080a8 | #9898b8 | #8080a8 |
| `--overlay-arrow-stroke` | #9898b8 | #9898b8 | #9898b8 | #9898b8 |
| `--overlay-inequality-fill` | #f1be32 | #c79100 | #ffe38a | #a97b00 |
| `--overlay-cage-stroke` | #9898b8 | #5555aa | #9898b8 | #5555aa |
| `--overlay-cage-sum` | #f1be32 | #c79100 | #ffe38a | #8a6a00 |
| `--overlay-jigsaw-stroke` | #9898b8 | #8080a8 | #ffffff | #0a0a23 |
| `--overlay-window-fill` | #3b3b4f | #e8e8fa | #5f5f81 | #8f8fa8 |
| `--overlay-special-fill` | #3a1a6a | #dcc8f4 | #655c8e | #a087c4 |
| `--overlay-kropki-light` | #f8f8ff | #f8f8ff | #f8f8ff | #f8f8ff |
| `--overlay-kropki-dark` | #4050a0 | #4050a0 | #4050a0 | #4050a0 |
