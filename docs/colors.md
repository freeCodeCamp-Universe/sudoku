...
| Token | Dark | Light |
| --- | --- | --- |
| `--bg-primary` | #0a0a23 | #f5f5f0 |
| `--bg-secondary` | #1b1b32 | #ebebe6 |
| `--bg-surface` | #2a2a40 | #e0e0db |
| `--border` | #3b3b4f | #c8c8d8 |
| `--text-muted` | #858591 | #6a6a7a |
| `--text-subtle` | #d0d0d5 | #2a2a40 |
...
| `--color-4` | #33a850 | #33a850 |
| `--color-5` | #1aabaa | #1aabaa |
| `--color-6` | #3a80e0 | #3a80e0 |
| `--color-7` | #8e52e8 | #8e52e8 |
| `--color-8` | #d94080 | #d94080 |
...
| `--cell-peer-overlay` | #8ea8ff29 | #3a4aa01a |
| `--cell-same-value-overlay` | #1fb5a852 | #1fa89c57 |
...
| `--overlay-consecutive-fill` | #d0d0e8 | #d0d0e8 |
| `--overlay-consecutive-stroke` | #1b1b32 | #1b1b32 |
