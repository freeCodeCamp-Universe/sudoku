...
| `--cell-diagonal-bg` | #3b3b4f | #e8e8fa | #3b3b4f | #e8e8fa |
| `--cell-window-bg` | #3b3b4f | #e8e8fa | #3b3b4f | #e8e8fa |
| `--cell-special-bg` | #3b3b4f | #e8e8fa | #3b3b4f | #e8e8fa |
...
| `--cell-selected-border` | #4a90d9 | #4a90d9 | #4a90d9 | #4a90d9 |
...
| `--overlay-window-fill` | #3b3b4f | #e8e8fa | #3b3b4f | #e8e8fa |
| `--overlay-special-fill` | #3a1a6a | #dcc8f4 | #3a1a6a | #dcc8f4 |
