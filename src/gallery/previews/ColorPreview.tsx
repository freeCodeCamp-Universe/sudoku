...
const COLORS_DARK  = ['#3a1a1a','#1a3a1a','#1a1a3a','#3a3a1a','#1a2a3a','#2a1a3a','#3a2a1a','#1a3a2a','#2a2a2a'];
const COLORS_LIGHT = ['#f0c8c8','#c8f0c8','#c8d4f8','#f0f0b8','#c0e4f0','#e0c8f8','#f8e0c0','#c0f0dc','#d8d8d8'];
