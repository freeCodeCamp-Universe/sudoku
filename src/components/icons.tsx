...
export function LearnIcon({ className, ...props }: IconProps) {
  return (
    <Icon {...props} className={className} viewBox="0 0 640 640">
      {/* !Font Awesome Free v7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc. */}
...
// ring), so the `filled` prop picks the state rather than a stroke.
export function StarIcon({
  ...
  return (
    <Icon {...props} className={className} viewBox="0 0 576 512">
      {/*!Font Awesome Free v7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.*/}
      {filled ? (
