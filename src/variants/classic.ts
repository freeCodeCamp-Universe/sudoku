  ...
  help: [
    {
      ...
      rules: [
        {
          term: 'The grid',
          text: 'A 9×9 board divided into nine 3×3 boxes. Fill every cell with a digit from 1 to 9.',
        },
        {
        ...
        {
          term: 'Boxes',
          text: 'Each of the nine 3×3 boxes must also hold every digit exactly once.',
        },
      ],
    },
    {
