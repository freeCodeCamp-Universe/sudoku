  ...
  help: [
    {
      ...
      rules: [
        {
          term: 'Dots',
          text: 'A dot between two adjacent cells means those symbols differ by exactly 1 (e.g. 4 and 5).',
        },
        {
          term: 'No dot',
          text: 'When two adjacent cells have no dot, their symbols must not differ by exactly 1.',
        },
        {
